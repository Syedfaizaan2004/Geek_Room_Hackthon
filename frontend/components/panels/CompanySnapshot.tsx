'use client';
import { TrendingUp, TrendingDown, Minus, DollarSign, Activity, AlertTriangle } from 'lucide-react';
        ...
        <div className="card">
            <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                    ...
                    <div className={`flex items-center gap-1 justify-end text-sm font-medium mt-0.5 ${isUp ? 'text-green-400' : 'text-red-400'}`}>
                        <TrendIcon size={14} />
